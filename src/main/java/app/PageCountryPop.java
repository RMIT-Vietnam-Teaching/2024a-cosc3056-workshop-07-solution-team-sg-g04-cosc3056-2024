 ...
 *
 * @author Tri Huynh 2924. email: tri.huynh5@rmit.edu.vn
 */
public class PageCountryPop implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        //  - The Country selected by the user, if any
        //  - Array list of all cities from the selected country
        //  - The Name and Population of the selected city, if any
        ...
        if (chosenCity != null) {
            ...
            System.out.println("ChosenCity is " + chosenCity);

            String[] CityNameAndPopulation = chosenCity.split("\\|");

            City selectedCity = new City(
                CityNameAndPopulation[0], 
                Integer.parseInt(CityNameAndPopulation[1]) 
            );
